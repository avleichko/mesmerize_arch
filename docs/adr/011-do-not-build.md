...
- **Sources:** Strategy Overview / Risks (pivot away from Redox & ambient), Architecture “What Is NOT In This Architecture”, Implementation Context removals, SOW #3 out-of-scope, ADRs 001–003, 009, 019
...
| DNB-9 | **No Mesmerize DICOM viewer and no server-side DICOM or imaging payloads.** | PHI/FDA; imaging **display** is in scope per [ADR-019](019-exam-room-imaging-display-and-evidence.md) |
